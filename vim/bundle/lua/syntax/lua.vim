...
syn region luaBlock transparent matchgroup=luaRepeat start="\<do\>" end="\<end\>" contains=ALLBUT,luaTodo,luaSpecial,luaCond,luaCondElseif,luaCondEnd,luaRepeat
...
" other keywords
syn keyword luaAssignment local
syn keyword luaStatement return  break
...
if version >= 508 || !exists("did_lua_syntax_inits")
  ...
  HiLink luaAssignment		Operator
  HiLink luaOperator		Boolean
