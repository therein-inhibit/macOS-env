...
\                       display
hi def link coffeeKeyword Repeat

syn match coffeeKeyword2 /\<\%(and\|or\|not\|is\|isnt\)\>/
\                       display
hi def link coffeeKeyword2 Conditional


syn match coffeeOperator /\<\%(instanceof\|typeof\|delete\)\>/ display
hi def link coffeeOperator Builtin

" The first case matches symbol operators only if they have an operand before.
syn match coffeeExtendedOp /\%(\S\s*\)\@<=[+\-*/%&|\^=!<>?.]\+\|[-=]>\|--\|++\|:/
\                          display
hi def link coffeeExtendedOp Operator
